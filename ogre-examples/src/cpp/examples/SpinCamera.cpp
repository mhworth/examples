...
namespace examples {
	...
	//--------------------------------------------
	void SpinCamera::stop() {
		this->mLog->logMessage("Stopping");
	}
	
	//--------------------------------------------
	void SpinCamera::createCameras() {
		
		cout << "Creating Camera from SpinCamera" << endl;
		 // Create the camera
        ...
        // Look back along -Z
        mCamera->lookAt(Vector3(-100,0,0));
